...
exports.fetchDocsMetadata = fetchDocsMetadata;
const axios_1 = __importDefault(require("axios"));
const feishuApi_1 = require("./feishuApi");
const logger_1 = require("./logger");
async function fetchDocsMetadata(docs) {
    ...
    for (let i = 0; i < docs.length; i += chunkSize) {
        ...
        try {
            ...
            const response = await axios_1.default.post('https://open.feishu.cn/open-apis/drive/v1/metas/batch_query', {
            ...
            if (response.data.code === 0 && response.data.data.metas) {
                response.data.data.metas.forEach((meta) => {
...
//# sourceMappingURL=feishuMeta.js.map